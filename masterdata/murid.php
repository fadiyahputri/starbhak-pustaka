...
<body>
    ...
    <div class="container" style="width: 100%; height: 90vh; display: flex;">
        <div class="sidebar" onmouseover="muncul(x)" onmouseout="hilang(x)">
            <div class="sidebar-top">
                ...
                <ul>
                    ...
                    <a href="" >
                    <li class="active">
                        <iconify-icon class="ic-sidebar active" icon="ph:student-bold"></iconify-icon>
      ...
      <g>
        ...
        <div class="page">
            <nav>
                <div class="text-page">
                    <h2 class="title-page">murid</h2>
                    <p class="route-page">starpus/murid</p>
                </div>
            ...
            <div class="content">
                ...
                <h3 class="title-content">Data murid</h3>
