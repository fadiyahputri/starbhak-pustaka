<?php  
    ...
    if(isset($_POST['simpandatamurid'])){
        ...
        $sql = "UPDATE datamurid SET id_murid='$id_murid',nama_murid='$nama_murid',jeniskelamin_murid='$jeniskelamin_murid',kelas_murid='$kelas_murid',email_murid='$email_murid',password_murid='$password_murid' WHERE id_murid='$id_murid'";
